...
document.getElementById('downloadBrowserButton').addEventListener('click', () => {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      downloadFile('https://drive.google.com/uc?export=download&id=1lvwTbq5PAQuNhzl1_B-GCHp1OdGCF433', 'LuxWar.rar');
      downloadFile('https://drive.google.com/uc?export=download&id=1p_HoTLFNFU0cpAjqJcsYjv7c-YglPOmB', 'cfg.rar');
    }, 1000);
...
document.getElementById('proceedButton').addEventListener('click', () => {
  window.location.href = 'https://drive.google.com/uc?export=download&id=1lvwTbq5PAQuNhzl1_B-GCHp1OdGCF433';
});
